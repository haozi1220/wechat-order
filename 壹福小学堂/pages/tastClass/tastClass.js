Page({
  ...
  infoTap:(e)=>{
    if (e.target.id == 'address' ){
      ...
      var url = "https://apis.map.qq.com/ws/geocoder/v1/?address=" + addTextSplit + "&key=GMTBZ-BMUKQ-3355M-GMGWB-YVVHF-3PFTH";
      // 小程序发送请求
      wx.request({ 
        url: url,
        method:'GET',
        ...
        success:(res)=>{
          ...
          wx.openLocation({
            ...
            address: res.data.result.address_components.city + res.data.result.address_components.district + res.data.result.address_components.street + res.data.result.address_components.street_number+'号'
          });
        }
      })
